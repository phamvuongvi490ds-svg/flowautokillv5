...
function policySafeInstruction(outLang='English'){
  if(outLang==='Vietnamese') return `YÊU CẦU AN TOÀN NỘI DUNG CHO GOOGLE/FLOW: Viết prompt theo hướng gia đình, điện ảnh, không gây hại. Không dùng hoặc mô tả trực diện các nội dung dễ bị chặn: khỏa thân, gợi dục, tình dục, trẻ em trong tình huống nhạy cảm, máu me, thương tích nặng, giết chóc, vũ khí thật, tự hại, ma túy, thù ghét, phân biệt chủng tộc, người nổi tiếng/người thật có danh tính, thương hiệu/logo/bản quyền, lừa đảo, hướng dẫn nguy hiểm hoặc hoạt động phạm pháp. Nếu ý tưởng gốc có yếu tố nhạy cảm, hãy tự chuyển thành phiên bản an toàn: hồi hộp nhưng không bạo lực, xung đột không máu me, trang phục kín đáo, nhân vật hư cấu trưởng thành, không logo/không thương hiệu, không nêu tên người nổi tiếng. Ưu tiên mô tả cảnh quay, ánh sáng, cảm xúc, chuyển động máy quay, môi trường, màu sắc, hành động đời thường an toàn. Không viết các từ khóa nhạy cảm nếu có thể thay bằng mô tả trung tính.`;
  return `GOOGLE/FLOW CONTENT-SAFE REQUIREMENT: Write family-safe cinematic prompts. Do not use or directly describe commonly blocked content: nudity, sexual content, minors in sensitive contexts, gore, severe injury, killing, real weapons, self-harm, drugs, hate, racism, identifiable real people/celebrities, brands/logos/copyrighted IP, scams, dangerous instructions, or illegal activity. If the source idea contains sensitive elements, rewrite it into a safe version: suspenseful but non-graphic, conflict without gore, modest clothing, fictional adult characters, no logos/brands, no celebrity names. Prioritize camera movement, lighting, emotion, environment, colors, and safe everyday actions. Avoid sensitive keywords when a neutral description works.`;
}
