...
async function applyModel(page){
  const labels={default:'Veo 3.1 - Fast',veo3_lite_low_priority:'Veo 3.1 - Lite [Lower Priority]',veo3_lite:'Veo 3.1 - Lite',veo3_fast:'Veo 3.1 - Fast',veo3_quality:'Veo 3.1 - Quality',nano_banana_pro:'Nano Banana Pro',nano_banana2:'Nano Banana 2',nano_banana:'Nano Banana 2',imagen4:'Imagen 4',omni_flash:'Omni 1.1 Flash'};
