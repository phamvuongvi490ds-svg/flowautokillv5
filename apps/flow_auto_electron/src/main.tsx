...
function App(){
  ...
  async function generateDancePrompts(){const r=await api().danceGenerate({video:danceVideo,modelImage:danceModelImage,outfits:danceOutfits,apiKey:firstKey(),apiModel:geminiApiModel,promptLang});if(r?.text)setDanceResult(r.text);append(r)}
