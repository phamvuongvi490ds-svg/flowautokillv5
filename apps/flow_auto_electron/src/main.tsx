...
function App(){
  ...
  async function runDanceFlow(){if(!dancePromptFile){append('❌ Hãy tạo prompt Dance trước khi chạy Flow.');return}await start(dancePromptFile,{mode:danceMode,model:danceModel,ratio:danceRatio,count:danceCount,omniDuration:danceDuration,runMode:danceRunMode,autoDownload:danceAutoDownload,downloadDir:danceDownloadDir,refsDir:'',pairedMode:false,refMode:'all'})}
